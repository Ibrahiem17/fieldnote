...
| 2026-09-21 | Visual redesign (D-046) on the A51 | **Pass (visual, by screenshot)** | Projects (stacked wavy coloured cards + arrows), Inspections (purple header, chips, timeline sheet), Settings (toned cards, no duplicate heading), Project detail (hero card), an inspection form (uppercase header, visible Draft badge, two-tone section heading). Not verified: animation feel, Login and New Project screens, PDF appearance after the change, iOS. |
