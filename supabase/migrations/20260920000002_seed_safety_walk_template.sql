...
values (
  ...
  'Site Safety Walk',
  1,
  $tmpl${"id":"site-safety-walk-v1","name":"Site Safety Walk","version":1,"sections":[{"id":"site","title":"Site","fields":[{"key":"site_location","type":"gps","label":"Site location"},{"key":"weather","type":"select","label":"Weather","options":[{"value":"clear","label":"Clear"},{"value":"rain","label":"Rain"},{"value":"wind","label":"High wind"}]},{"key":"crew_size","type":"number","label":"People on site","min":0,"max":500}]},{"id":"hazards","title":"Hazards","fields":[{"key":"ppe_worn","type":"boolean","label":"Everyone wearing required PPE"},{"key":"hazard_level","type":"select","label":"Hazard level","required":true,"options":[{"value":"none","label":"None"},{"value":"low","label":"Low"},{"value":"high","label":"High"}]},{"key":"hazard_notes","type":"longtext","label":"Describe the hazard","visibleIf":{"field":"hazard_level","in":["low","high"]}},{"key":"hazard_photos","type":"photo","label":"Photograph the hazard","maxCount":5,"visibleIf":{"field":"hazard_level","in":["high"]}}]},{"id":"signoff","title":"Sign-off","fields":[{"key":"walk_notes","type":"longtext","label":"Notes"},{"key":"inspector_signature","type":"signature","label":"Inspector signature"}]}]}$tmpl$
)
